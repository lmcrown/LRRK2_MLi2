function INTAN_Post_Process_LRRK2_MLi2_LC_from_multi_RHD(plot_it)
...
fileinfo=dir('time.dat');  %this stuff just taken from the INTAN_Load_Time function and cut and pasted to work here without an info.rhd
...
fclose(fid); 
t = t / fs_initial; % sample rate from header file
LFP_t_sec = t';


 save('LFP_t_sec','LFP_t_sec','-v7.3');  %it wont save because its too big
