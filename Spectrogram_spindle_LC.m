function [C,fq,T] = Spectrogram_spindle_LC(raw_lfp, sFreq, Fqs_to_plot, type)
...
% Cowen 2015
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
window = 24; % 64 this seems to be ideal for 1800Hz sFreq ripples.
overlap = 18; % 56 this seems to be ideal for 1800Hz sFreq ripples.
if nargin < 4
    type = 'wavelet';
end
if nargin < 3
    Fqs_to_plot = 3:0.2:30;
end
